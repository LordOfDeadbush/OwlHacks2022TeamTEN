...
//   const id = windows.navigator.geolocation.watchPosition(
//     positionCallback,
//     errorCallback,
...
//   return value === null ? "NA" : value.toFixed(fix) +
//     " " + unit;
// }

// function getSpeedInMi(value, unit = "", fix = 0) {
//   return value === null ? "NA" : (value * 1609.344).toFixed(fix) +
//     " " + unit;
// }

// function positionCallback(position) {
//   longitude.innerText = getValue(position.coords.longitude,
//     "°", 6);
//   latitude.innerText = getValue(position.coords.latitude,
//     "°", 6);
//   accuracy.innerText = getValue(position.coords.accuracy,
//     "m", 2);
//   altitude.innerText = getValue(position.coords.altitude,
//     "m", 2);
...
//     2
//   );
//   heading.innerText = getValue(position.coords.heading,
//     "°", 2);
//   speed.innerText = getSpeedInMi(position.coords.speed, "mi/s", 2);
//   time.innerText =
...
//       msg = "DENIED ACCESS FOR LOCATION";
//       break;
